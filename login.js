function trocarTela () {
    ...
    document.getElementById("titulo-login").innerHTML="Cadastre-se<br>E entre para o nosso time"
}

function voltarTela () {
    document.getElementById("loginModal").style.display="none"
    document.getElementById("login-row").style.display="grid"
    document.getElementById("titulo-login").innerHTML="Faça Login<br>E entre para o nosso time"
}
